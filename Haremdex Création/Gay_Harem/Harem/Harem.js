...
function viewImage5(id, idImage, Name, ava, spe, rar) { 
        ...
        <div>
        <p class="name${rar}"><!a href="Filles/${idImage}/${Name}.html" style="color: white;"><span class="div_class_items">${Name}</span><!/a> <img class="iconom" src="../../Autres/carac/${spe}.png"></p>
        <img class="ava" src='Filles/${idImage}/ava${ava}.png'>
        </div>
        <div class="stars${spe}">
